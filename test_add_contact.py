...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        wd.find_element_by_name("home").send_keys("HomeTelephone")
        wd.find_element_by_name("theform").click()
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("MobileTelephone")
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("WorkTelephone")
        ...
        wd.find_element_by_name("notes").send_keys("SecondaryNotes")
